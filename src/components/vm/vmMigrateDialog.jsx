                               ...
                               label={
                                   <>
                                       ...
                                       <Tooltip
                                           ...
                                           content={
                                               <>
                                                   <p>{_("When shut off on the destination, this virtual machine will return to the original host in a shut off state.")}</p>
...
export const MigrateDialog = ({ vm, connectionName, toggleModal }) => {
    ...
    function onMigrate() {
        ...
        setInProgress(true);
        return migrateToUri(connectionName, vm.id, destUri, storage, live, temporary)
    ...
    const dataCorruptionWarning = () => {
        ...
        if (storage === "shared" && temporary && hasWriteableDisks) {
